...
parser = argparse.ArgumentParser(description="Parser for user-specifible dataset paths.")

parser.add_argument("trimmap_dir", type=str, help="The trimmap directory")
parser.add_argument("dataset_dir", type=str, help="The data directory")

args = parser.parse_args()

trimmap_dir = args.trimmap_dir
